...
const BuyerRequestsDashboard = () => {
  ...
  const getStatusBadge = (status) => {
    const statusColors = {
      ...
      Cancelled: "bg-gray-100 dark:bg-black/80 text-gray-800 dark:text-gray-300 border border-gray-200 dark:border-gray-700",
    };
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-6 transition-colors duration-300">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Tabs */}
        <div className="flex flex-wrap gap-2 bg-white dark:bg-black/90 p-1.5 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 w-fit">
          {[
        ...
        {activeTab === "received-offers" ? (
          ...
          allOffersLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {allOffers.length === 0 ? (
                <div className="md:col-span-2 lg:col-span-3 bg-white dark:bg-black/90 rounded-3xl shadow-sm p-12 text-center border border-gray-100 dark:border-gray-800">
                  <div className="bg-gray-50 dark:bg-black/80 p-4 rounded-full inline-flex mb-4">
                ...
                allOffers.map((offer) => (
                  <div
                    key={offer._id}
                    className="bg-white dark:bg-black/90 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden hover:shadow-md transition-all group flex flex-col"
                  >
                    {/* Car Image Header */}
                    <div className="h-48 relative overflow-hidden bg-gray-100 dark:bg-black/80">
                          ...
                          className={`px-3 py-1 rounded-lg text-xs font-bold uppercase shadow-sm backdrop-blur-md ${offer.status === "Pending"
                            ...
                            : offer.status === "Accepted"
                              ...
                              : offer.status === "Rejected"
                                ...
                                : "bg-gray-100/90 dark:bg-black/80/90 text-gray-800 dark:text-gray-200"
                            }`}
                        >
                    ...
                    <div className="p-5 flex-1 flex flex-col">
                      <div className="mb-4">
                        ...
                        <div className="flex items-center text-gray-500 dark:text-gray-400 text-xs font-medium bg-gray-50 dark:bg-black/80 px-2 py-1 rounded-lg w-fit">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-6">
                        <div className="bg-gray-50 dark:bg-black/80 p-3 rounded-2xl">
                      ...
                      <div className="mt-auto grid grid-cols-2 gap-2 pt-4 border-t border-gray-50 dark:border-gray-800">
                        ...
                        <button
                          ...
                          className="flex items-center justify-center py-2.5 bg-white dark:bg-black/80 border border-red-100 dark:border-red-900/30 text-red-600 dark:text-red-400 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors font-bold text-sm"
                        >
                          Odrzuć
                        </button>
                      </div>
                        ...
                        className={`px-3 py-1 rounded-lg text-xs font-bold uppercase tracking-wider ${request.status === "Active"
                          ...
                          : request.status === "Fulfilled"
                            ...
                            : request.status === "Cancelled"
                              ...
                              : "bg-gray-100 dark:bg-black/80 text-gray-700 dark:text-gray-400"
                          }`}
                      >
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                      ...
                      <div className="flex items-center justify-between py-3 border-t border-b border-gray-50 dark:border-gray-800 mb-4">
                        ...
                        <button
                          ...
                          className={`flex items-center gap-1 text-xs font-bold px-2 py-1 rounded-lg transition-colors ${expandedRequests.has(request._id) ? "bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300" : "bg-gray-100 dark:bg-black/80 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700"
                            }`}
                        >
                          <FiDollarSign />
                      ...
                      <div className="flex gap-2">
                        ...
                        <Link
                          ...
                          className="p-2.5 bg-white dark:bg-black/80 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                          title="Edytuj"
                        >
                        ...
                        <button
                          ...
                          className="p-2.5 bg-white dark:bg-black/80 border border-red-100 dark:border-red-900/30 text-red-500 dark:text-red-400 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
                          title="Usuń"
                        >
                      ...
                      {expandedRequests.has(request._id) && (
                        <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-800 animate-in slide-in-from-top-2">
                          ...
                          {!requestOffers[request._id] ? (
                            ...
                            <div className="text-center py-4 bg-gray-50 dark:bg-black/80 rounded-xl border border-dashed border-gray-200 dark:border-gray-700">
                            ...
                            <div className="space-y-2">
                              {requestOffers[request._id]
                                ...
                                .map((offer) => (
                                  <div
                                    key={offer._id}
                                    className="bg-gray-50 dark:bg-black/80 rounded-xl p-3 border border-gray-100 dark:border-gray-700 flex gap-3 items-center group/offer hover:border-blue-100 dark:hover:border-blue-900 hover:bg-blue-50/30 dark:hover:bg-blue-900/20 transition-colors"
                                  >
                                    <div className="h-10 w-14 bg-white dark:bg-black/90 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 flex-shrink-0">
                                      {offer.carInfo?.images?.[0] ? (
        ...
        {showOffersModal && selectedRequest && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
            <div className="bg-white dark:bg-black/90 rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-200 border border-transparent dark:border-gray-800">
              <div className="flex justify-between items-center p-6 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-black/80/50">
                <div>
              ...
              <div className="flex-1 overflow-y-auto p-6 bg-gray-50 dark:bg-gray-950">
                {offersLoading ? (
                  ...
                  <div className="text-center py-12 bg-white dark:bg-black/90 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 m-4">
                  ...
                  <div className="space-y-4">
                    {offers.map((offer) => (
                      <div
                        key={offer._id}
                        className="bg-white dark:bg-black/90 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-800 hover:shadow-md transition-shadow"
                      >
                        <div className="flex flex-col md:flex-row gap-6">
                          {/* Car Images */}
                          <div className="w-full md:w-1/3 bg-gray-100 dark:bg-black/80 rounded-xl overflow-hidden self-start">
                            {offer.carInfo?.images?.[0] ? (
                            ...
                            <div className="p-3 bg-gray-50 dark:bg-black/80/50 border-t border-gray-100 dark:border-gray-800">
                          ...
                          <div className="flex-1 flex flex-col">
                                  ...
                                  className={`inline-block mt-1 px-3 py-1 rounded-lg text-xs font-bold uppercase ${offer.status === "Pending"
                                    ...
                                    : offer.status === "Accepted"
                                      ...
                                      : offer.status === "Rejected"
                                        ...
                                        : "bg-gray-100 dark:bg-black/80 text-gray-800 dark:text-gray-300"
                                    }`}
                                >
                                  {offer.status}
                                </span>
                            ...
                            <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
                              {offer.sellerInfo && (
                                <div className="flex items-center gap-3 bg-gray-50 dark:bg-black/80 px-3 py-2 rounded-xl w-full md:w-auto">
                              ...
                              <div className="flex gap-2 w-full md:w-auto">
                                ...
                                <button
                                  onClick={() => handleRejectOffer(offer._id)}
                                  className="flex-1 md:flex-none px-6 py-2.5 bg-white dark:bg-black/80 border border-red-100 dark:border-red-900/30 text-red-600 dark:text-red-400 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors font-bold text-sm"
                                >
                                  Odrzuć
                                </button>
                              </div>
