...
const conversations = [
  {
    ...
    messages: [
      ...
      {
        text: "Hello, Jasmin Trewen! Welcome to the Champion Store WhatsApp! Let me know how I can help you.",
        sender: "agent",
        time: "9:57 AM",
      },
      {
      ...
      {
        text: "What would you like to talk about? Can I help you?",
        sender: "agent",
        time: "10:15 AM",
      },
      {
        text: "I bought a book some time ago, but I lost it. What should I do? Should I buy it again here or just try to find it?",
        sender: "user",
        time: "10:28 AM",
      },
    ],
  },
  {
    ...
    messages: [
      {
        text: "Hello! Is this the number of the Champion store?",
        sender: "user",
        time: "9:56 AM",
      },
      {
        text: "Hello, Jonas Kahnwald! Welcome to the dashboard.",
        sender: "agent",
        time: "9:57 AM",
      },
      {
        text: "I want to add a new car to the website.",
        sender: "user",
        time: "10:07 AM",
      },
      {
      ...
      {
        text: "I bought a book  What should I do? Should I buy it again here or just try to find it?",
        sender: "user",
        time: "10:28 AM",
      },
    ],
