  ...
  return (
    <div className="bg-gradient-to-r from-gray-50 to-white border-b border-gray-100 shadow-sm">
      <div className="w-full lg:w-[50vw] px-4 lg:px-6 py-6">
        ...
        {/* First Line: Make Model Type Year From Year To */}
        <div className="flex items-center justify-between w-full">
            ...
            <div className="relative flex-1 mx-0.5 my-0.5" ref={yearDropdownRef}>
              <button
            ...
            <button
              ...
              className={`flex items-center gap-1 lg:gap-2 px-2 py-1.5 lg:px-3 lg:py-2 text-xs lg:text-sm font-medium border border-gray-200 rounded-md lg:rounded-lg focus:outline-none transition-all duration-200 whitespace-nowrap shadow-sm hover:shadow-md flex-1 justify-center mx-0.5 my-0.5 ${
                showMoreFilters 
            ...
            >
              ...
              <svg className={`w-3 h-3 lg:w-4 lg:h-4 transition-transform ${showMoreFilters ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
              </svg>
            </button>
        </div>
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <div className="relative flex-1 mx-0.5 my-0.5">
                <input
                  ...
                  className="px-3 py-2 text-sm font-medium border border-gray-200 rounded-lg focus:outline-none bg-white shadow-sm hover:shadow-md transition-all duration-200 w-full"
                />
              </div>
        ...
        <div className="flex justify-start">
          <button
            onClick={handleReset}
            className="px-2 py-1.5 lg:px-3 lg:py-2 text-xs lg:text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 border border-gray-200 rounded-md lg:rounded-lg transition-all duration-200 shadow-sm hover:shadow-md w-20 lg:w-24 mx-0.5 my-0.5"
          >
            Reset
          </button>
        </div>
